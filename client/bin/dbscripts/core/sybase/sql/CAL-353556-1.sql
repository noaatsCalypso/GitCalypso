select t1.trade_id, t1.keyword_value into temp_trade_keyword from(select tk1.trade_id,tk1.keyword_value from trade_keyword tk1 where tk1.keyword_name ='TransferDate') t1,
