sp_rename inv_cash_balance ,inv_cash_balance_back161
go
sp_rename inv_cash_movement , inv_cash_movement_back161
go
sp_rename inv_sec_balance ,inv_sec_balance_back161
go
sp_rename inv_sec_movement ,inv_sec_movement_back161
go
create table inv_cash_balance(internal_external varchar(32) not null,
...
mcc_id  numeric  default 0 not null  ,
...
insert into inv_cash_balance select  internal_external ,
 position_type  ,
 agent_id  ,
 account_id  ,
 date_type ,
...
go
create table inv_cash_movement (internal_external varchar(32) not null,
position_type varchar(32) not null,
agent_id  numeric not null,
account_id  numeric not null,
date_type varchar(32) not null,
...
internal_external  varchar(32) not null,
        position_type  varchar(32) not null,
        date_type  varchar(32) not null,
        agent_id   numeric not null,
        account_id   numeric not null,
...
insert into  inv_sec_movement  select  
internal_external,
position_type,
date_type,
agent_id,
