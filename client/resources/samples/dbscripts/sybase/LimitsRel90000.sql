...
CREATE TABLE ers_limit_adjustment
   (
	...
	user_name		varchar(32)	NOT NULL,
     	CONSTRAINT UNIQ_ers_limit_adjustment PRIMARY KEY (adjustment_id)
   )
...
grant INSERT,UPDATE,SELECT,DELETE on ers_limit_adjustment_reject to public
GO
...
grant INSERT,UPDATE,SELECT,DELETE on ers_limit_adjustment_authorise to public
GO
...
grant INSERT,UPDATE,SELECT,DELETE on ers_limit_adjustment_pending to public
GO
