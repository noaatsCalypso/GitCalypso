...
CREATE  INDEX IDX_ers_addon ON ers_addon(addon_setname, addon_key, seq_id)
GO

GRANT SELECT,INSERT,DELETE,UPDATE ON ers_addon TO public
go
...
GRANT SELECT,INSERT,DELETE,UPDATE ON ers_addon_buckets TO public
go
...
grant INSERT,UPDATE,SELECT,DELETE on ers_limit_reserve to public
GO
...
(
	...
	amount_base	float		NOT NULL,
     	CONSTRAINT PK_ers_exposure_measure PRIMARY KEY (julian_offset, trade_id, measure)
)
GO

GRANT SELECT,INSERT,DELETE,UPDATE ON ers_exposure_measure TO public
go
...
(
	...
	is_default	int		NOT NULL,
     	CONSTRAINT PK_ers_measure_config PRIMARY KEY (service, measure)
)
GO

GRANT SELECT,INSERT,DELETE,UPDATE ON ers_measure_config TO public
go

DELETE ers_measure_config
GO
